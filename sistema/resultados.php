  ...
  <section id="container" >
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Elegidos de la semana</h3>
          <div class="row mt">
            <div class="col-lg-12">
              <div class="panel panel-primary">
                  <div class="panel-heading">Hola bastardo, escogiste los siguientes resultados: (luego no andes mamando)</div>
                  <div class="panel-body">
                      <div class="table-responsive">
                        <!-- <CREACION DE LA TABLA DE RESULTADOS> -->
                        <?php include("resultados/15partidos.php") ?>
                      </div>
                  </div>
              </div>
            </div>
